...
for i = 1:length(trainNum)
    ...
    testPatchesOrder = setdiff([1:24],trainPatchesOrder);
    testPatchesNum = length(testPatchesOrder);
    RGB_train = RGB_A(trainPatchesOrder,:);
    RGB_test = RGB_A(testPatchesOrder,:);
    SPD_train = SPD_A(trainPatchesOrder,:);
    SPD_test = SPD_A(testPatchesOrder,:);
